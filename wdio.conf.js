export const config = {
  ...
  maxInstances: 10,
  suites: {
    feature1: ["./features/login.feature"],
    feature2: ["./features/Logout.feature"],
    feature3: ["./features/Failed_connection.feature"],
  ...
  //       "allure",
  //       {
  //         outputDir: "C:/test_io/Reports/allure-results", // Specify the output directory for Allure reports
  //       },
  //     ],
  //   ],
